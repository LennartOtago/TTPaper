...
By exploratory analysis we define ranks \textcolor{red}{$r=[ 1,  10,  10, 10, 10, 10, 5, 3, 3, 3, 3, 3, 3 , 3, 3, 3, 3, 3, 1]$} manually and set the grid size $n=30$ for the 18-dimensional parameter space, see Tab.\ref{tab:priors} for the grid bounds.
...
This requires 34080 function evaluations.
...
The maximum IACT is $\approx 1.2\pm 0.1$, hence every second marginal posterior sample generated by the SIRT scheme presents an independent sample from the marginal posterior.
...
To obtain an approximation of the marginal posterior 34080 function evaluations are required.
