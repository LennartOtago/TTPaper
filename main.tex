...
First, a $d$-dimensional grid with $n$ grid points in each dimension the parameter space is defined by $n^d$ grid points.
This is computationally not feasible to represent naively in a $d$-dimensional tensor, so a TT is employed to approximate the target function on that parameter space.
